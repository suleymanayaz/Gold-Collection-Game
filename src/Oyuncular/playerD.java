...
public class playerD extends Player {
     private int moveCost = 5,targetCost = 20,goldAmount = 200 ,goldAmountSpent,totalNumberSteps,amountGoldCollected,stepsNumber = 3;
    ...
    public void yollarıbul(Point start,Point end,Oyun oyun){
        ...
        if(mesafe(current,last)<=getStepsNumber()){
            System.out.println("Steps Number :   :: "+getStepsNumber());
