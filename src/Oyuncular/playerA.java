...
public class playerA extends Player {
   ...
   public boolean getHedef(){
    ...
    public void hedefBelirle(Oyun oyun){
        ...
        int lastMesafe=0;
        int newMesafe = 0;// uzaklıgı en uzun 40 olabilceği için yazıyorum
      
        // kendine en yakin altinlari buldu bular bir arraylistte tutulsun 
        // ordan random secilerek hedef belirlensin
